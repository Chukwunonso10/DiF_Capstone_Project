  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:flex">
        {showDesktopSidebar && (
          <div
            className={`fixed left-0 top-0 h-full bg-white border-r border-gray-200 z-30 transition-all duration-300 shadow-lg ${
              ...
              {sidebarItems.map((item, index) => {
                ...
                if (item.onClick) {
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-4 px-6 py-3 text-left hover:bg-gray-100 transition-all duration-200 ${
                ...
                return (
                  <Link
                    key={index}
                    to={item.path}
                    className={`flex items-center gap-4 px-6 py-3 hover:bg-gray-100 transition-all duration-200 ${
                      item.isActive ? "font-semibold" : ""
                    }`}
                  >
                    {item.id === "profile" ? (
